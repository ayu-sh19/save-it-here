...
export function TopBar() {
  return (
    <div className="fixed top-0 left-0 right-0 h-[60px] bg-[rgba(244,235,215,0.95)] border-b-[3px] border-[var(--ink)] flex items-center px-6 z-50 backdrop-blur-sm">
      ...
      <div className="flex-1 max-w-[560px] mx-8 relative hidden md:block">
        <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--ink-60)]" />
        <input 
          type="text" 
          placeholder="Global Search............." 
          className="w-full py-2.5 pl-11 pr-4 bg-[var(--white)] border-2 border-[var(--ink)] font-body text-sm shadow-[3px_3px_0_var(--ink)] focus:shadow-[0_0_0_var(--ink)] focus:border-[var(--crimson)] transition-all outline-none"
        />
